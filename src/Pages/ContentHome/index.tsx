...
import { Container, IntroduceContainer, SpendsContainer, CharityContainer, WaistContainer, EntrepreneurContainer}from './style.js'
  ...
  return(
    ...
    <Container>
      <IntroduceContainer >
        ...
        <LottieMaker lottieImage={"https://assets4.lottiefiles.com/packages/lf20_ihxIYc.json"} height={300} width={300} playerAreVisible={false}/>
        </div>
      </IntroduceContainer>
      <SpendsContainer >
        <div className='text-introduce' id='div2'>
          <h2>Anote os gastos</h2>
          <p>Faça o acompanhar quanto ganhou e quanto tem gastado, mostre o valor de guardar dinheiro para poder comprar algo que possa vir a querer, dar valor a ter dinheiro guardado e tentar prever possíveis gastos futuros.</p>
        </div>
        <div className='lottie-container' id='div2-img'>
          <LottieMaker lottieImage={"https://assets5.lottiefiles.com/packages/lf20_boxe3lx3.json"} height={400} width={375} playerAreVisible={false}/>
        </div>
      </SpendsContainer >
      <CharityContainer >
      ...
      <WaistContainer>
        ...
        <div id='div4-img'>
          <LottieMaker lottieImage={"https://assets10.lottiefiles.com/packages/lf20_CIPL1V.json"} height={400} width={375} playerAreVisible={false}/>
        </div>
      </WaistContainer>
